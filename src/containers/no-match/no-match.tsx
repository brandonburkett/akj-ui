  ...
  <React.Fragment>
    ...
    <div id="main" className="group" role="main">
        ...
        <div className="panel_content">
          <div className="content group">
            <div className="cs12">
              ...
              <p>The page you're looking for either doesn't exist or there was an internal error for your
                request.</p>
              <p>&nbsp;</p>
            </div>
          </div>
      ...
      <section id="testimonial" className="group">
        <div className="quote">
          <p>&ldquo;The most difficult rival you will ever face is yourself.&rdquo; - Sekiguchi Komei
            sensei</p>
        </div>
      </section>
    </div>
